...
const CreateTicketForm = ({ onSubmit, onCancel, isLoading = false }: CreateTicketFormProps) => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white dark:bg-slate-800/50">
      <div className="mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Actions */}
        <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-slate-700/50">
          <Button
            type="button"
            variant="outline"
            onClick={onCancel}
